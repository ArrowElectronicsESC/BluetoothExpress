...
class ColorWheel(Widget):
	...
	def recolor_wheel(self):
		...
		for idx, segment in enumerate(self.arcs):
			print (self.sv_s[int(self.sv_idx + idx / ppie)])
...
class ColorPicker(RelativeLayout):
	...
	def on_color(self, instance, value):
		...
		temp = ("RED: {} BLUE: {} GREEN: {} AMBER: {}".format(value[0],value[1],value[2],value[3])).encode()
		#print (temp)
		red = str(int(value[0] * 255)).zfill(3)
		blue = str(int(value[1] * 255)).zfill(3)
		green = str(int(value[2] * 255)).zfill(3)
		amber = str(int(value[3] * 255)).zfill(3)
		temp = ("{}{}{}{}".format(red,blue,green,amber)).encode()
		#print (temp)
		ser.write(temp)
